...
//Stworzenie niezbędnych hook;ów
   ...
   const [currentQuestion, setQuestion] = useState(questions[currentIndex]);//Aktulane pytanie
   const [currentPoints, setPoints] = useState(0);//Wartosc pkt
   const [allowToChoose, changePermission] = useState(true);//Moziwlosxc wyboru odpowiedzi
   const [markedAnswer, markAnswer] = useState({key: -1, variant: ''});//Sprawdxanir odp
